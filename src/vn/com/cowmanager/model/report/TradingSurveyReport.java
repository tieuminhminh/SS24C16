...
public class TradingSurveyReport {
	private static Integer idCounter = 0;

	@DAttr(name = "id", id = true, auto = true, type = Type.Integer, length = 5, optional = false, mutable = false)
	private Integer id;

	@DAttr(name = "outStandard", type = Type.String, length = 25, optional = false)
	...
	@DAssoc(ascName = "tradingSurveyReport-has-cageManager", role = "tradingSurveyReport", ascType = AssocType.One2Many, endType = AssocEndType.One, associate = @Associate(type = CageManager.class, cardMin = 0, cardMax = MetaConstants.CARD_MORE))
	@Output
	...
	public TradingSurveyReport(@AttrRef("outStandard") String outStandard)
	...
	private void doQueryReport() throws NotPossibleException, DataSourceException {
		...
		// parameter value(s)
		Query q = QueryToolKit.createSearchQuery(dsm, CageManager.class, new String[] { CageManager.A_outStandard },
				new Op[] { Op.MATCH }, new Object[] { "%" + outStandard + "%" });
	...
	public void setOutStandard(String outStandard) throws NotPossibleException, DataSourceException {
		boolean doQueryReport = (outStandard != null && !outStandard.equals(this.outStandard));
	...
	public String toString() {
		...
		return "Report(" + id + outStandard + ((cageManagers != null) ? "Ok" : "Null") + ")";
	}
